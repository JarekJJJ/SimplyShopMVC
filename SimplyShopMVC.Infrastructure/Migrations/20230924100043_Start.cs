    ...
    public partial class Start : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConnectArticleTag", x => new { x.ArticleId, x.ArticleTagId });
                    table.ForeignKey(
                        name: "FK_ConnectArticleTag_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConnectArticleTag_ArticleTags_ArticleTagId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemSymbol = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VatRate = table.Column<int>(type: "int", nullable: false),
                    ImageFolder = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConnectItemTag", x => new { x.ItemId, x.ItemTagId });
                    table.ForeignKey(
                        name: "FK_ConnectItemTag_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConnectItemTag_ItemTags_ItemTagId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    DeliveryTime = table.Column<int>(type: "int", nullable: false),
                    NetPurchasePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    FinalPriceA = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConnectArticleTag_ArticleTagId",
                table: "ConnectArticleTag",
                column: "ArticleTagId");

            migrationBuilder.CreateIndex(
                name: "IX_ConnectItemTag_ItemTagId",
                table: "ConnectItemTag",
                column: "ItemTagId");
